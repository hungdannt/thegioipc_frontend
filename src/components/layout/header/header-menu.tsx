  ...
  return (
    <nav
      className={classNames(
        `headerMenu font-header flex w-full relative`,
        className
      )}
    >
      {data?.map((item: any) => (
        ...
        >
          <Link
            href={item.path}
            className="inline-flex items-center text-base xl:text-base text-heading px-3 xl:px-4 py-2 font-bold relative group-hover:text-black"
          >
            {t(item.label)}
